...
label_1 = Label(root, text="CONTACT",width=20,font=("bold", 10))
...
list1 = ['AHMEDABAD','SURAT','MUMBAI','KOLKATA','KANPUR','LUCKNOW'];
c=StringVar()
...
label_4 = Label(root, text="STATES",width=20,font=("bold", 10))
label_4.place(x=70,y=350)

list1 = ['GUJARAT','MAHARASHTRA','UTTARPRADESH','WEST BENGAL'];
c=StringVar()
droplist=OptionMenu(root,c, *list1)
droplist.config(width=15)
c.set('Select your country') 
...
label_4.place(x=85,y=400)
var1 = IntVar()
Checkbutton(root, text="PHP", variable=var1).place(x=235,y=400)
var2 = IntVar()
Checkbutton(root, text="Python", variable=var2).place(x=290,y=400)

Button(root, text='Submit',width=20,bg='green',fg='white', command = validate).place(x=190,y=450)
